...
function mathOp(
  ...
  return {
    ...
    namedArgumentList: [],
    unnamedArgumentList: [{ description: "Two numbers separated by space", isRequired: true }],
  };
}

function unaryMathOp(name: string, helpString: string, fn: (a: number) => number): SlashCommand {
  return {
    name,
    callback: (_args, unnamed) => {
    ...
    returns: "Numeric result",
    namedArgumentList: [],
    unnamedArgumentList: [{ description: "A number", isRequired: true }],
  };
}
...
export const mathCommands: SlashCommand[] = [
  ...
  unaryMathOp("sqrt", "Square root", Math.sqrt),
  {
    ...
    namedArgumentList: [],
    unnamedArgumentList: [{ description: "String to measure", isRequired: true }],
  },
  {
    name: "rand",
    callback: (_args, unnamed) => {
    ...
    namedArgumentList: [],
    unnamedArgumentList: [{ description: "min max (default: 0 100)", isRequired: false }],
  },
];
