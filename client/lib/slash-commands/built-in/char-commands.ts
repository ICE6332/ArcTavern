...
export const charCommands: SlashCommand[] = [
  {
    ...
    unnamedArgumentList: [
      { description: "Message text", isRequired: true },
    ],
  },
  {
    name: "sys",
    ...
    namedArgumentList: [],
    unnamedArgumentList: [
      { description: "System message text", isRequired: true },
    ],
  },
  {
    name: "nar",
    ...
    namedArgumentList: [],
    unnamedArgumentList: [
      { description: "Narration text", isRequired: true },
    ],
  },
  {
    name: "dupe",
    ...
    namedArgumentList: [
      { name: "id", description: "Character ID to duplicate", isRequired: true },
    ],
    unnamedArgumentList: [],
  },
  {
