...
export const varCommands: SlashCommand[] = [
  ...
  },
  {
    ...
    aliases: [],
    returns: "The variable value",
    namedArgumentList: [{ name: "key", description: "Variable name", isRequired: true }],
    unnamedArgumentList: [{ description: "Value to set (omit to get)", isRequired: false }],
  },
  {
    name: "setvar",
    callback: (args, unnamed, ctx) => {
    ...
    returns: "The variable value",
    namedArgumentList: [{ name: "key", description: "Variable name", isRequired: true }],
    unnamedArgumentList: [{ description: "Variable value", isRequired: false }],
  },
  {
    name: "getvar",
  ...
  },
  {
    ...
    namedArgumentList: [{ name: "key", description: "Variable name", isRequired: true }],
    unnamedArgumentList: [{ description: "Value to add", isRequired: true }],
  },
  {
    name: "incvar",
    callback: (args, _unnamed, ctx) => {
